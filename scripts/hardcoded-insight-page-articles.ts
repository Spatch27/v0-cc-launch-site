/**
 * Legacy hardcoded Insight article records.
 * Used only by scripts/import-insights-to-sanity.ts so re-imports stay possible.
 * Public Insights pages read from Sanity, not from this file.
 */
export type HardcodedInsightPageArticle = {
  title: string
  excerpt: string
  category: string
  date: string
...
export const hardcodedInsightPageArticles: Record<string, HardcodedInsightPageArticle> = {
