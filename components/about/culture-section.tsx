    ...
    <Section background="dark" compact>
      <motion.div variants={fadeInUp}>
        ...
        <div className="max-w-3xl space-y-6 text-lg leading-relaxed text-brand-white/70">
          <p>
            We don't hide behind slide decks. We show up inside your team, alongside the people actually doing the work. We run workshops that leave people energised. Not drained by another afternoon of sticky notes and false consensus.
          </p>
          <p>
