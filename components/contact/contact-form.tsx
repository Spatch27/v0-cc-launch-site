            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group mt-4 inline-flex w-fit items-center gap-3 self-start rounded-md border-2 border-brand-dark bg-brand-light px-8 py-4 text-base font-semibold text-brand-dark transition-all duration-300 hover:bg-brand-white disabled:opacity-50"
