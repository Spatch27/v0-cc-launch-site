      ...
      <div className="mx-auto flex max-w-[1400px] flex-col pt-20 lg:pt-28 pb-24 lg:pb-16 gap-52 lg:gap-32 lg:h-full lg:justify-between">
        ...
        >
          <p className="max-w-2xl text-right text-xl leading-relaxed text-brand-dark">
            We work with CMOs and their teams to remove operational drag, one fix at a time. Every six-week cycle targets a specific outcome, proves what changed and builds <strong>the confidence to go further.</strong>
          </p>
        </motion.div>
      </div>
    </motion.section>
